...
//         this.block[1].x=size.width*0.2;
//         this.block[1].y=size.height*0.4;
//
//
//         // this.trap[0]=new TrapTrapClass(res.Cactus_png);
//
//         //坐标错误
//
//         this.bg.addChild(this.bg1, 0, cc.p(1.0, 1.0), cc.p(this.bg1.width / 2, this.bg1.height / 2));
//         // this.bg.addChild(this.block[0], 1, cc.p(1.0,1.0), cc.p(this.bg1.width*0.5, this.bg1.height*0.2));
//         // this.bg.addChild(this.block[1], 1, cc.p(1.0, 1.0), cc.p(this.bg1.width*0.2, this.bg1.height*0.4));
//         // this.bg.addChild(this.trap[0], 1, cc.p(1.0, 1.0), cc.p(this.bg1.width*0.5, this.bg1.height*0.3));
...
//     //     var trapBox=this.trap[0].getBoundingBox();
